...
from unicollege.students.forms import CourseEnrollForm
...
class InstructorEditMixin(object):
...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def get_form(self, model, *args, **kwargs):
        Form = modelform_factory(model, exclude=['instructor',
                                                 'order',
                                                 'created',
                                                 'updated'])
...
class ContentDeleteView(View):
    def post(self, request, id):
        content = get_object_or_404(Content, id=id, module__course__instructor=request.user)
