...
MIGRATION_MODULES = {"sites": "unicollege.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "unicollege.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "unicollege.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
